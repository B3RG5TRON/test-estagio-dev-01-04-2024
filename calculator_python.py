def calculator(consumption: list, distributor_tax: float, tax_type: str) -> tuple:
    ...
    media = sum(consumption) / len(consumption)

    # Define as taxas de desconto com base no consumo médio
    if media < 10000:
        coverage = 0.90
    ...
    # Calcula as economias anuais e mensais
    annual_savings = desconto * 12
    monthly_savings = desconto

    # Imprime e retorna os resultados
    results = (
